...
<script type="text/javascript">
	...
	$(function(){
		...
		/**
		 * 提供的值：aid
		 * 返回的值：arList:activityRemarkList
		 */
		activityRemarkList()
    ...
    function activityRemarkList(){
        $.ajax({
            url:"workbench/activity/getActivityRemarkListById.do",
            data:{
                "id":"${a.id}"
            },
            dataType:"json",
            ...
            success:function (data){
                ...
                $.each(data,function (i,n){
                    ...
                    html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id="s'+n.id+'">'+(n.editFlag==1?n.editTime:n.createTime)+'由'+n.createBy+'</small>'
                    html+='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">'
    ...
    function editRemark(id){
        var text=$("#"+id).children("div").children("h5").text()
