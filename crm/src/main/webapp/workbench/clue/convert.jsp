	...
	$(function(){
		...
		$("#searchActivityBtn").keydown(function (event){
			if(event.keyCode==13){
				$.ajax({
					...
					data:{
						"searchText":$.trim($("#searchActivityBtn").val())
					},
					dataType:"json",
					type:"get",
		...
		$("#convertBtn").click(function (){
			...
			if(checked){
				...
				//不添加交易
				window.location.href="workbench/clue/convertClue.do?clueId=${param.id}&flag="+checked
			}
...
<%--							</tr>--%>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		<form action="workbench/clue/convertClue.do" method="post" id="tranForm">
